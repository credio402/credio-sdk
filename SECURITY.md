...
report it privately â€” do **not** open a public issue.

- Open a private security advisory: **GitHub â†’ Security â†’ Report a vulnerability**
  on this repository, or
- Reach out through the contact channels on [credio.fun](https://credio.fun).
...
- This SDK is a thin, **zero-secret** HTTP client. It never handles or stores
  private keys, and authentication to Credio is simply your Base wallet
